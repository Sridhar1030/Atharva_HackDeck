...
const faqs = [
    {
        question:
            "What provisions are in place for disabled persons during elections in India?",
    ...
    {
        question:
            "Are there any special voting arrangements for disabled voters?",
    ...
    {
        question:
            "What measures are taken to ensure the secrecy of votes for disabled persons?",
    ...
    {
        question:
            "How can disabled voters access information about their voting rights?",
    ...
    {
        question:
            "What steps are being taken to create awareness about voting rights for disabled persons?",
    ...
    {
        question:
            "How can disabled voters report issues they face during elections?",
    ...
    {
        question:
            "What initiatives are there to improve accessibility in future elections?",
...
const faqsHindi = [
    {
        question:
            "भारत में चुनावों के दौरान दिव्यांग व्यक्तियों के लिए क्या प्रावधान हैं?",
    ...
    {
        question:
            "दिव्यांग व्यक्तियों के लिए वोटों की गोपनीयता सुनिश्चित करने के लिए क्या उपाय किए जाते हैं?",
    ...
    {
        question:
            "दिव्यांग मतदाता अपने मतदान अधिकारों के बारे में जानकारी कैसे प्राप्त कर सकते हैं?",
    ...
    {
        question:
            "दिव्यांग व्यक्तियों के मतदान अधिकारों के बारे में जागरूकता पैदा करने के लिए कौन से कदम उठाए जा रहे हैं?",
    ...
    {
        question:
            "दिव्यांग मतदाता चुनावों के दौरान जिन समस्याओं का सामना करते हैं, उन्हें कैसे रिपोर्ट कर सकते हैं?",
    ...
    {
        question:
            "भविष्य के चुनावों में सुलभता सुधारने के लिए कौन से पहलों हैं?",
...
const faqsMarathi = [
    {
        question:
            "भारतामध्ये निवडणुकांदरम्यान दिव्यांग व्यक्तींसाठी कोणते नियम आहेत?",
    ...
    {
        question:
            "दिव्यांग व्यक्तींसाठी मतदानाची गुप्तता सुनिश्चित करण्यासाठी कोणते उपाय केले जातात?",
    ...
    {
        question:
            "दिव्यांग मतदार त्यांच्या मतदान अधिकारांची माहिती कशी मिळवू शकतात?",
    ...
    {
        question:
            "दिव्यांग व्यक्तींच्या मतदान अधिकारांबद्दल जागरूकता निर्माण करण्यासाठी कोणती पावले उचलली जात आहेत?",
    ...
    {
        question:
            "दिव्यांग मतदार निवडणुकांदरम्यान तोंड देणाऱ्या समस्यांची माहिती कशी देऊ शकतात?",
    ...
    {
        question:
            "भविष्यातील निवडणुकांमध्ये सुलभता सुधारण्यासाठी कोणती उपक्रम आहेत?",
...
const Faq = () => {
    ...
    const getAudioText = (index) => {
        const currentFaqs = getFaqsByLanguage();
        return currentFaqs[index].answer;
    };

    const playSpeech = (index) => {
        const text = getAudioText(index);
    ...
    // Function to play all FAQs in the selected audio language
    const playAllFaqs = () => {
        const currentFaqs = getFaqsByLanguage();
        currentFaqs.forEach((faq) => {
            const speech = new SpeechSynthesisUtterance(faq.answer);
    ...
    return (
        <div className="bg-[#FFFCFA]">
            <div className="py-8 px-8 md:px-32">
                ...
                {/* Audio Language Selection Buttons */}
                <div className="mb-4 flex space-x-2">
                    <span className="font-bold">Select Audio Language: </span>
                    <button
                    ...
                    <button
                        onClick={() => setAudioLanguage("marathi")}
                        className={`px-4 py-2 rounded-md ${
                            audioLanguage === "marathi"
                                ? "bg-[#00395d]"
                                : "bg-[#004274] hover:bg-[#00395d]"
                        }`}
                    >
                ...
                {/* Button to play all FAQs */}
                <div className="mb-4">
                    <button
                        onClick={playAllFaqs}
                        className="px-4 py-2 bg-blue-500 text-white rounded-md"
                    >
                        Play All FAQs in {audioLanguage}
                    </button>
                </div>
                            ...
                            {openIndex === index && (
                                <div className="mt-2">
                                    ...
                                    <div className="mt-4 flex items-center">
                                        <button
                                            onClick={() => playSpeech(index)}
                                            className="px-4 py-2 bg-blue-500 text-white rounded-md"
                                        >
                                            Play Answer in {audioLanguage}
                                        </button>
                                    </div>
                                </div>
                            )}
